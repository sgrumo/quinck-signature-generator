    ...
    <h2 style="margin: 0">Quinck</h2>
        ...
        <td style="padding-left: 10px;">
            <table cellspacing="0" cellpadding="0">
                <tbody>
                    <tr>
                        <td style="font-size: 10pt; color: #0079ac; font-family: Arial, sans-serif; width: 400px; padding-bottom: 5px; padding-left: 10px; vertical-align: top;" valign="top"><strong><span style="font-size: 11pt; font-family: Arial, sans-serif; color: #2175b5;">${name}</span></strong><strong style="font-family: Arial, sans-serif; font-size: 11pt; color: #000000;"> | ${role} </strong></td>
                    </tr>
                    <tr>
                        <td style="font-size: 10pt; color: #444444; font-family: Arial, sans-serif; padding-bottom: 5px; padding-top: 5px; padding-left: 10px; vertical-align: top; line-height: 17px;" valign="top">
                          <!-- <span style="color: #2175b5;"><strong>a: </strong></span>
                          ...
                          <!-- | <span style="color: #2175b5;"><strong>p:</strong></span> <span style="font-size: 10pt; font-family: Arial, sans-serif; color: #000000;"> (800) 555-0199</span> -->
                        </td>
                    </tr>
                    <tr>
                        ...
                        <!-- <a href="https://www.facebook.com/Quinckiot" target="_blank" rel="noopener">
                            <img style="border: 0; height: 19px; width: 19px; margin-right:10px" src="https://codetwocdn.azureedge.net/images/mail-signatures/generator-dm/bease-fox/fb.png" alt="facebook icon" width="19" border="0" />
                          </a>
                            ...
                            <a href="https://www.linkedin.com/company/quinck/" target="_blank" rel="noopener"><img style="border: 0; height: 19px; width: 19px;; margin-right:10px" src="https://quinck-open.s3-eu-west-1.amazonaws.com/linkedin-logo.png" alt="linkedin icon" width="19" border="0" /></a>
                            ...
                            <!-- <a href="https://pinterest.com/mycompany404/" target="_blank" rel="noopener"><img style="border: 0; height: 19px; width: 19px;" src="https://codetwocdn.azureedge.net/images/mail-signatures/generator-dm/bease-fox/pt.png" alt="pinterest icon" width="19" border="0" /></a> -->
                        </td>
                    </tr>
                </tbody>
            </table>
